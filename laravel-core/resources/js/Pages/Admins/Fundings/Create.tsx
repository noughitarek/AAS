import { Desk, Investor, PageProps, Product } from "@/types";
...
const CreateFunding: React.FC<PageProps<{investors: Investor[], products: Product[], desks: Desk[]}>> = ({ auth, menu, investors, products, desks }) => {
    const { data, setData, post, processing, errors } = useForm<FundingtForm>({
        total_amount: 0,
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('admins.fundings.create'));
    };
    ...
    return (
        <>
            ...
            >
                <Page title="Create a funding" header={<></>}>
