import { Investor, PageProps } from "@/types";
...
const EditInvestor: React.FC<PageProps<{investor: Investor}>> = ({ auth, menu, investor }) => {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('admins.investors.edit', {investor}));
    };
    ...
    return (
        <>
            ...
            >
                <Page title="Edit a investor" header={<></>}>
